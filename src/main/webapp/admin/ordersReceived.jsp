            ...
            <td><i class="fa fa-inr"></i> <%=rs.getString(5) %> </td>
             ...
             <td><%=rs.getString(11) %></td>
              <td><%=rs.getString(12) %></td>
               ...
               <td><a href="cancel.jsp?id=<%=rs.getString(2) %>&email=<%=rs.getString(1)%>">Cancel <i class='fas fa-window-close'></i></a></td>
                <td><a href="delivered.jsp?id=<%=rs.getString(2) %>&email=<%=rs.getString(1)%>">Delivered <i class='fas fa-dolly'></i></i></a></td>
            </tr>
         <%
       	}
       	}
